...
from lms_core.views import index, testing, addData, editData, deleteData, RegisterView, pending_comments, approve_comment, CommentApproveView, UserActivityDashboardView, AvailableContentView, CourseAnalyticsView
...
from lms_core.views import CourseEnrollmentView, EnrollView
...
urlpatterns = [
    ...
    path('api/available-contents/', AvailableContentView.as_view(), name='available-contents'),
